...
export function ProfilePanel({
  ...
  return (
    <div className="mx-auto max-w-3xl rounded-lg border border-[#2a3340] bg-[#0d1117] px-5 py-6">
      <div className="mb-5">
        <h2 className="text-lg font-bold text-white">{m.profile.title}</h2>
      ...
      <div className="flex flex-col gap-5">
        <section className="rounded-lg border border-[#2a3340] bg-[#0a0e14] p-4">
          <h3 className="mb-1 text-xs font-bold uppercase tracking-widest text-[#6b7280]">
        ...
        <section className="rounded-lg border border-[#2a3340] bg-[#0a0e14] p-4">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            <input
              ...
              maxLength={40}
              className="min-w-0 flex-1 rounded border border-[#2a3340] bg-[#0d1117] px-3 py-2 text-sm text-white outline-none focus:border-[var(--accent)]"
            />
            <button
              type="button"
              onClick={handleSave}
              className="rounded bg-[var(--accent)] px-4 py-2 text-sm font-bold uppercase tracking-wide text-[var(--accent-on)] hover:bg-[var(--accent-hover)]"
            >
          ...
          <button
            ...
            className="mt-2 w-full rounded border border-[var(--accent)]/50 py-2 text-xs font-semibold uppercase tracking-wide text-[var(--accent-muted)] transition-colors hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]"
          >
        ...
        <section className="rounded-lg border border-[#2a3340] bg-[#0a0e14] p-4">
          ...
          <button
            ...
            className="w-full rounded border border-[var(--accent)]/50 py-2.5 text-sm font-bold uppercase tracking-wide text-[var(--accent-muted)] transition-colors hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]"
          >
          ...
          {saved.length === 0 ? (
            ...
            <ul className="flex flex-col gap-2">
              {saved.map((cfg) => (
                <li
                  key={cfg.id}
                  className="rounded border border-[#2a3340] bg-[#0d1117] p-3"
                >
