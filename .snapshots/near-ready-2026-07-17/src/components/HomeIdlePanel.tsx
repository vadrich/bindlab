    ...
    >
      ...
      >
        ...
        {leftItems.map((item, i) => (
          <div
            key={item.id}
            className="welcome-row flex items-start gap-3 rounded-lg border border-[#2a3340] bg-[#141920] px-3 py-2.5 transition-colors hover:border-[#3a4555]"
            style={{
              borderLeftWidth: 3,
