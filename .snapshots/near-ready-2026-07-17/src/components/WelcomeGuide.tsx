  ...
  return (
    <div className="mx-auto max-w-3xl px-1 py-1">
      ...
      >
        ...
        >
          <div className="rounded-lg border border-[#2a3340] bg-[#141920] p-4 transition-colors hover:border-[#3a4555]">
        ...
        <h3
          className="welcome-fade-up mb-3 mt-6 text-xs font-bold uppercase tracking-widest text-[#9ca3af]"
        ...
        <ul className="flex flex-col gap-2.5">
          {tabRows.map((row, i) => (
            <li
              key={row.name}
              className="welcome-row rounded-lg border border-[#2a3340] bg-[#141920] px-3.5 py-3"
              style={{
                borderLeftWidth: 3,
