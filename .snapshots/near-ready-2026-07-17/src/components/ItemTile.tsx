...
export function ItemTile({
  ...
  return (
    <button
      ...
      className={[
        'group relative aspect-[98/68] w-full overflow-hidden rounded-sm transition-all duration-150',
        selected
          ? 'bg-[var(--accent-soft)] shadow-[inset_0_0_0_2px_var(--accent-ring)]'
          : 'bg-[rgba(0,0,0,0.48)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08)] hover:bg-[rgba(0,0,0,0.62)] hover:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.18)]',
      ].join(' ')}
    >
