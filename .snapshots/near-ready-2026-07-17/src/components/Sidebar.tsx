...
function CommandBlock({
  ...
  return (
    <div className="mb-4 last:mb-0">
      ...
      <pre
        className={[
          'mb-2 overflow-auto whitespace-pre-wrap break-all rounded border border-[#2a3340] bg-[#0d1117] p-3 font-mono text-xs leading-relaxed text-[var(--accent-muted)]',
                ...
                {pasteChunks.map((chunk, i) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="shrink-0 rounded bg-[var(--accent)] px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wide text-[var(--accent-on)] hover:bg-[var(--accent-hover)]"
                    >
